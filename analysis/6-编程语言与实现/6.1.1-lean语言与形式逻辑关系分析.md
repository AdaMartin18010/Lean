...
6. Avigad, J., & Massot, P. (2021). *Mathematics in Lean*. Lean Community.
7. de Moura, L., & Ullrich, S. (2021). "The Lean 4 Theorem Prover and Programming Language". *CADE 2021*.
8. Carneiro, M. (2019). "Lean 4: A Modern Theorem Prover". *CICM 2019*.

### 形式化验证与证明

9. Harrison, J. (2009). *Handbook of Practical Logic and Automated Reasoning*. Cambridge University Press.
10. Paulson, L. C. (1994). *Isabelle: A Generic Theorem Prover*. Springer.
11. Bertot, Y., & Castéran, P. (2004). *Interactive Theorem Proving and Program Development*. Springer.

### 哲学与认识论

12. Dummett, M. (1977). *Elements of Intuitionism*. Oxford University Press.
13. Heyting, A. (1956). *Intuitionism: An Introduction*. North-Holland.
14. Troelstra, A. S., & van Dalen, D. (1988). *Constructivism in Mathematics*. North-Holland.

### 计算机科学与类型理论

15. Pierce, B. C. (2002). *Types and Programming Languages*. MIT Press.
16. Reynolds, J. C. (1998). *Theories of Programming Languages*. Cambridge University Press.
17. Cardelli, L., & Wegner, P. (1985). "On Understanding Types, Data Abstraction, and Polymorphism". *Computing Surveys*.
