...
- **人工智能与机器学习**: [4.1-人工智能与机器学习](4.1-人工智能与机器学习.md)
- **Petri网与分布式系统**: [../1-形式化理论/1.4-Petri网与分布式系统.md)
- **时序逻辑与控制**: [../1-形式化理论/1.3-时序逻辑与控制.md)
- **架构与设计模式**: [../5-架构与设计模式/5.1-架构设计与形式化分析.md)

### 导航

- **返回上级**: [4-行业领域分析](../4-行业领域分析.md)
- **英文版本**: [4.2-internet-of-things-and-edge-computing.md](../4-industry-domains-analysis/4.2-internet-of-things-and-edge-computing.md)
- **下一个主题**: [4.x-其他行业主题](4.x-其他行业主题.md)

### 扩展学习路径

1. **IoT系统架构**: 学习 [4.2.1-IoT系统架构全景](4.2-物联网与边缘计算.md#421-iot系统架构全景)
2. **边缘计算模型**: 深入 [4.2.2-分布式边缘计算模型](4.2-物联网与边缘计算.md#422-分布式边缘计算模型)
3. **形式化建模与验证**: 探索 [4.2.3-形式化建模与验证](4.2-物联网与边缘计算.md#423-形式化建模与验证)
4. **工程实践案例**: 实践 [4.2.7-工程实践案例](4.2-物联网与边缘计算.md#427-工程实践案例)

---

**返回上级**: [4-行业领域分析](../4-行业领域分析.md) | **下一个**: [4.x-其他行业主题](4.x-其他行业主题.md)
