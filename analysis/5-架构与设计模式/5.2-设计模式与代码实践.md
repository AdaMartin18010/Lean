...
### 相关主题
- [5.1-架构设计与形式化分析](./5.1-架构设计与形式化分析.md)
...
#### 延伸阅读
- [函数式编程设计模式](https://www.manning.com/books/functional-programming-in-scala)
- [并发编程模式](https://www.oreilly.com/library/view/java-concurrency-in/9780137001291/)
- [微服务设计模式](https://www.manning.com/books/microservices-patterns)
