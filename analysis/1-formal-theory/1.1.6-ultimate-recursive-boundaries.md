...
- [1.1.6 Ultimate Recursive Boundaries and Self-Reference Limits](#116-ultimate-recursive-boundaries-and-self-reference-limits)
  ...
  - [1.1.6.4 Gödelian and Tarskian Limits](#1164-godelian-and-tarskian-limits)
    - [Gödel's Incompleteness Extended](#godels-incompleteness-extended)
    - [Tarski's Undefinability Generalized](#tarskis-undefinability-generalized)
    - [Löb's Theorem and Self-Reference](#lobs-theorem-and-self-reference)
