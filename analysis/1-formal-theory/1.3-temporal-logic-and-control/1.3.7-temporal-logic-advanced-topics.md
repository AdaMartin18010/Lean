...
3. **Hansson, H., & Jonsson, B. (1994)**. "A logic for reasoning about time and reliability". *Formal Aspects of Computing*, 6(5), 512-535.
4. **Baier, C., et al. (2003)**. "Model-checking algorithms for continuous-time Markov chains". *IEEE Transactions on Software Engineering*, 29(6), 524-541.

### 混成系统验证

5. **Platzer, A. (2018)**. *Logical Foundations of Cyber-Physical Systems*. Springer.
6. **Henzinger, T. A. (2000)**. "The theory of hybrid automata". *Verification of Digital and Hybrid Systems*, 265-292.

### 量子时序逻辑

7. **Baltag, A., & Smets, S. (2006)**. "LQP: The dynamic logic of quantum information". *Mathematical Structures in Computer Science*, 16(3), 491-525.
8. **Ying, M. (2016)**. *Foundations of Quantum Programming*. Morgan Kaufmann.

### 多智能体与认知逻辑

9. **Alur, R., et al. (2002)**. "Alternating-time temporal logic". *Journal of the ACM*, 49(5), 672-713.
10. **Fagin, R., et al. (2003)**. *Reasoning About Knowledge*. MIT Press.
